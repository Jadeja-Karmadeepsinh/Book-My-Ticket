...
export const registerSchema = z.object({
    ...
    password: z.string().min(8, "Password must be at least 8 characters long").regex(passwordRegex, { message: passwordMessage })
})
...
export const resetPasswordSchema = z.object({
    ...
    newPassword: z.string().min(8, "Password must be at least 8 characters long").regex(passwordRegex, { message: passwordMessage })
})  